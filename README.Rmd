...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/zmij)](https://cran.r-project.org/package=zmij)
...
vectorized R interface to the [zmij](https://github.com/dtolnay/zmij)
Rust crate, a port of Victor Zverovich's
